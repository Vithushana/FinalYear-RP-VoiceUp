...
const Verified: React.FC = () => {
    ...
    const fetchIssues = async () => {
        try {
            ...
            if (officerId) {
                const data = await ApiService.getOfficerIssues(officerId, 'verified', 50);
            ...
            console.error('Error fetching verified issues:', error);
            setIssues([]);
        } finally {
            setLoading(false);
        }
        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1">
                <div className="bg-white border-b p-4 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800">Verified Issues</h1>
                ...
                <div className="p-6">
                    ...
                    {issues.length === 0 && (
                        <div className="text-center py-12">
                            <div className="text-gray-500 text-lg">No verified issues found</div>
                        </div>
                    )}
                </div>
            </div>
