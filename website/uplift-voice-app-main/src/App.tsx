...
import ComplaintDetailsSa from "./pages/ComplaintDetails_SA/ComplaintDetails_sa";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/complaint/:id" element={<ProtectedRoute><ComplaintDetailsSa /></ProtectedRoute>} />
