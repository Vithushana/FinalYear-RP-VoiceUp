...
const Seen: React.FC = () => {
    ...
    const fetchIssues = async () => {
        try {
            ...
            if (officerId) {
                const data = await ApiService.getOfficerIssues(officerId, 'seen', 50);
            ...
            console.error('Error fetching seen issues:', error);
            setIssues([]);
        } finally {
            setLoading(false);
        }
        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1">
                <div className="bg-white border-b p-4 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800">Seen Issues</h1>
                ...
                <div className="p-6">
                    ...
                    {issues.length === 0 && (
                        <div className="text-center py-12">
                            <div className="text-gray-500 text-lg">No seen issues found</div>
                        </div>
                    )}
                </div>
            </div>
