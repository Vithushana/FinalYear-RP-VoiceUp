...
const Completed: React.FC = () => {
  ...
  const fetchIssues = async () => {
    try {
      ...
      if (officerId) {
        const data = await ApiService.getOfficerIssues(officerId, 'completed', 50);
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1">
        <div className="bg-white border-b p-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-800">Completed Issues</h1>
        ...
        <div className="p-6">
                ...
                <CardContent className="p-4 h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-end">
                    <Button
                      ...
                      className="bg-green-500 hover:bg-green-600 text-white px-4 py-1 text-sm rounded-md"
                    >
                      Details
                    </Button>
                  </div>
          ...
          {issues.length === 0 && (
            <div className="text-center py-12">
              <div className="text-gray-500 text-lg">No completed issues found</div>
              <p className="text-sm text-gray-400 mt-2">Successfully resolved issues will appear here</p>
            </div>
          )}
        </div>
      </div>
