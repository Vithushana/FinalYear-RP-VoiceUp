...
const Achievements = () => {
  const [achievements, setAchievements] = useState<Achievement[]>([
    {
      id: "1",
      title: "Road Crack Fixed",
      description: "A significant road crack near the town center has been repaired successfully.",
      location: "Town Center, Colombo",
      posted_date: "2025-07-28",
      image_posted: "/images/image 13.png",
      image_completed: "/images/image 14.png",
    },
    {
      id: "2",
      title: "Pothole Repair",
      description: "Potholes on the main road have been filled, ensuring smooth traffic flow.",
      location: "Main Road, Colombo",
      posted_date: "2025-07-29",
      image_posted: "/images/image 15.png",
      image_completed: "/images/image 16.png",
    },
  ]);
