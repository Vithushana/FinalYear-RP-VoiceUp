...
const PendingIssues: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        // adjust these keys if your backend sends different fields
        setUserName(user.name || user.fullName || user.username || user.email || "Owner");
      } catch (e) {
  ...
  const fetchIssues = async () => {
    try {
      setLoading(true);
      // Fetch issues with status "Verified" (pending for owner to process)
      const data = await ApiService.getIssues(50, 0, "Verified");
      setIssues(data);
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1">
        ...
        <div className="bg-white border-b p-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-800">Pending Issues</h1>
                  ...
                  <CardContent className="p-4 h-full flex flex-col">
                    ...
                    <div className="mb-3">
                      <img
                        src={
                          ...
                          pendingImages[index % pendingImages.length]
                        }
                        alt={issue.title}
                    ...
                    <div className="flex items-center justify-end">
                      <Button
                        ...
                        className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-1 text-sm rounded-md"
                      >
                        details
                      </Button>
                    </div>
