...
import { Bell, Search, User, XCircle } from "lucide-react";
...
const Closed: React.FC = () => {
  const [issues, setIssues] = useState<Issue[]>([]); // ✅ typed issues
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        // update this based on your actual user object shape
        setUserName(
                    ...
                    <div className="mb-3">
                      <img
                        src={
                          ...
                          closedImages[index % closedImages.length]
                        }
                        alt={issue.title}
